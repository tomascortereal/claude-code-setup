...
process.stdin.on('end', () => {
  ...
  try {
    ...
    // PS1-style prefix: user@host:dir (green user@host, blue dir)
    ...
    if (task) {
      process.stdout.write(`${ps1Prefix} │ ${gsdUpdate}\x1b[2m${model}\x1b[0m │ \x1b[1m${task}\x1b[0m │ \x1b[2m${dirname}\x1b[0m${ctx}`);
    } else {
      process.stdout.write(`${ps1Prefix} │ ${gsdUpdate}\x1b[2m${model}\x1b[0m │ \x1b[2m${dirname}\x1b[0m${ctx}`);
    }
  } catch (e) {
